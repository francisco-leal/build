  ...
  return (
    ...
    >
      <g clipPath="url(#clip_content_files)">
        ...
        />
        <path
          d="M43.44 34.29H41.145V36.57H43.44V34.29Z"
          fill={color || "#FBFCFE"}
        />
        <path
          d="M43.4401 41.145H29.7151V43.425H43.4401V41.145Z"
          fill={color || "#FBFCFE"}
        />
        <path
          d="M41.145 11.4301H38.865V13.7101H41.145V11.4301Z"
          fill={color || "#FBFCFE"}
        />
        <path
          d="M38.865 36.5699H34.29V38.8649H38.865V36.5699Z"
          fill={color || "#FBFCFE"}
        />
        <path
          d="M32.0101 34.29H29.7151V36.57H32.0101V34.29Z"
          fill={color || "#FBFCFE"}
        />
      </g>
      <defs>
