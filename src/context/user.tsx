...
export const UserContext = createContext<UserContextType>({ user: null, authUser: async () => false });
...
export const UserProvider: React.FunctionComponent<UserProviderProps> = ({ children }) => {
    ...
    const authUser = async () => {
        ...
        const verification = await fetch('/api/profile', {
            ...
            body: JSON.stringify({ wallet_address: address, siwe: { message, signature, nonce } }),
            credentials: 'include'
        });
