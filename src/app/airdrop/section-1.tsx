    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Name the builders breaking the corporate mold, and receive an airdrop of $BOSS. Search their name or share your custom link.
                </Typography>
                ...
                >
                    <Autocomplete
                        ...
                        renderOption={(props, option) => (
                            <Stack sx={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", py: 1, px: 2, }}>
                                <Typography {...props}>{option}</Typography>
                                <Button variant="solid" onClick={() => handleUserSelect(option)} sx={{ py: "2px", px: "12px" }}>Nominate</Button>
                            </Stack>
                        )}
                    />
                </Stack>
                ...
                >
                    ...
                    >
                        ...
                        <Stack sx={{ gap: 2, width: "100%" }}>
                            <Box sx={{ backgroundColor: "common.black", opacity: "0.3", height: "1px", width: "100%" }} />
                        ...
                        <Stack sx={{ flexDirection: "row", justifyContent: "end", gap: 1, }}>
                            <Button variant="outlined" color="neutral" onClick={handleCancel} sx={{ color: "neutral.500", borderColor: "neutral.500" }}>Cancel</Button>
                ...
                <Link href="#" sx={{ color: "common.white", textDecoration: 'underline' }}>Share your nomination link</Link>
            </Stack >
        </Stack >
    )
};