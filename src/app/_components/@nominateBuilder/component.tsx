...
import { Avatar, Button, Divider, Modal, ModalClose, ModalDialog, ModalOverflow, Stack, Typography, useTheme } from "@mui/joy"
...
export const NominateBuilderComponent : FunctionComponent<NominateBuilderComponentProps> = ({
    connected,
    loading,
    date,
    ...
    return (
        <Modal open onClose={() => router.push(backPath)}>
            <ModalOverflow>
                <ModalDialog
                    variant="solid"
