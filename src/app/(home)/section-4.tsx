    ...
    return (
        <HeroSection sx={{ color: 'common.white' }}>
            ...
            <Stack sx={{ flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', gap: 3 }}>
                <Stack sx={{ height: '100%', flex: 1, alignItems: 'center', minHeight: 320, py: 5 }}>
                ...
                <Stack sx={{ height: '100%', flex: 1, alignItems: 'center', minHeight: 320, py: 5 }}>
                    ...
                    <Typography>
                        Join on party.app until May 7th, to help us raise LP funds and launch the $BOSS token together!
                        More info in Bossnomics.
                    </Typography>
