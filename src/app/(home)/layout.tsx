      ...
      <Stack component="main">
        <HeroSectionSlim>
          ...
          <Typography level="title-lg" sx={{ maxWidth: "sm" }}>
            ...
            : there&apos;s no room for builders in the corporate world! Stand
            for builders, play the nomination game, and earn $BOSS. Nominations
            start on May 8th.
          </Typography>
        ...
        >
          ...
          <BlockyCard sx={{ minHeight: 250 }}>
            ...
            <Typography textColor="neutral.500">
              Players have a daily budget of BOSS points to donate to 3 builders
              a day. Points will convert to $BOSS tokens in June.
            </Typography>
          </BlockyCard>
        </HeroSection>
        ...
        <HeroSection sx={{ color: "common.white" }}>
          ...
          >
            ...
            >
              ...
              <Typography>
                Claim your Talent Passport, and increase your Builder Score
                before the first snapshot, on May 7th at 17:59 UTC.
              </Typography>
