    ...
    return (
        <HeroSection>
            ...
            <Typography level="body-lg" textColor={'common.white'}>
                60% of tokens are intended for the community and ecosystem. The other 40% are related with the initial
                liquidity pool on Uniswap and liquidity mining rewards.
            </Typography>
            ...
            <Sheet variant="outlined" sx={{ width: '100%', py: { xs: 5, md: 5 }, px: { xs: 5, md: 20 } }}>
                ...
                <Box
                    ...
                    src={MOBILE_GRAPH}
                    alt="graph"
                    sx={{ width: '100%', height: 'auto', display: { xs: 'block', sm: 'none' } }}
                />
            </Sheet>
        </HeroSection>
    );
