...
const handler = frames(async (ctx) => {
  ...
  return {
      ...
      <div tw="relative w-full h-full flex bg-[#0042F5] text-white">
        ...
        <div tw="absolute top-0 left-0 w-full h-full flex flex-col justify-start p-[20px]">
          <div tw="flex flex-col w-full h-full justify-center items-center">
            ...
            <div tw="flex flex-col w-[900px] px-[20px] bg-white text-[#0042F5]">
              <p tw="text-[48px]">
                Simply tag @buildbot in a cast, and include the following
                details:
              </p>
              <p tw="ml-[20px] my-0">* Project description</p>
              <p tw="ml-[20px] my-[10px]">* Link</p>
              <p tw="ml-[20px] my-0">* Video or image</p>
            </div>
    ...
    buttons: [
      <Button action="link" key="1" target="https://warpcast.com/">
        Cast
      </Button>,
